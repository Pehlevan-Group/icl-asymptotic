...
d = 40
alphas =[5]#[0.25,0.5,0.75,1,5,10,50];
# kappas = np.logspace(np.log10(0.5),np.log10(10),50); Ks = np.int64(kappas*d);
# print(Ks)
Ks = list(np.int64(np.logspace(np.log10(2),np.log10(10*d),40))); Ks = np.array(Ks); kappas = Ks/d;
...
for a in range(len(alphas)):
    ...
    icl, idg = bayes_estimator(d,Ks,N,1,0.1,10000)
