...
from task.regression import LinearRegressionQuad
...
trainobject = LinearRegressionQuad(n_points = N+1, n_dims= d, eta_scale = sigma, w_scale = psi, batch_size = P, seed=None);
...
numsamples = 10000
testobject = LinearRegressionQuad(n_points = N+1, n_dims= d, eta_scale = sigma, w_scale = psi, batch_size = P, seed=None);
